...
static const unsigned int refresh_rate =
    240; /* matches dwm's mouse event processing to your monitor's refresh rate
...
static Keychord *keychords[] = {
    ...
    &((Keychord){1, {{0, XF86XK_MonBrightnessUp}}, spawn, SHCMD("xbacklight -inc 10")}),
    &((Keychord){1, {{0, XF86XK_MonBrightnessDown}}, spawn, SHCMD("xbacklight -dec 10")}),
    &((Keychord){1, {{0, XF86XK_AudioLowerVolume}}, spawn, SHCMD("amixer sset Master 5%- unmute")}),
    &((Keychord){1, {{0, XF86XK_AudioMute}}, spawn, SHCMD("amixer sset Master $(amixer get Master | grep -q ""'\\[on\\]' && echo 'mute' || echo 'unmute')")}),
    &((Keychord){1, {{0, XF86XK_AudioRaiseVolume}}, spawn, SHCMD("amixer sset Master 5%+ unmute")}),
