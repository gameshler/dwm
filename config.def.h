...
static const int cursorwarp =
    1; /* 1 means warp cursor to center of focused window/monitor */
static const unsigned int snap = 32; /* snap pixel */
static const int swallowfloating =
    0; /* 1 means swallow floating windows by default */
/* Window swallowing: when you launch a GUI app from a terminal, the terminal */
/* hides and the GUI app takes its place. Set isterminal=1 in rules[] for your
 * terminal. */
...
/* key definitions */
/* Mod4Mask = Super/Windows key (recommended), Mod1Mask = Alt key (suckless
 * default) */
